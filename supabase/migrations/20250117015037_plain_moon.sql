...
-- Create improved name validation function
...
BEGIN
  ...
  -- This regex includes all Unicode letters, including accented characters
...
BEGIN
  ...
  IF NOT validate_full_name(NEW.full_name) THEN
    RAISE EXCEPTION 'Nome inválido. Insira nome e sobrenome (mínimo 2 letras cada) usando apenas letras.';
  END IF;
